...
def add_logic_python(ob, script_name, module_name="", use_pulse_true_level=False, state=0, tick_skip=0, use_priority=False):
...
def remove_game_property(ob, prop_name):
	for i, prop in enumerate(ob.game.properties):
