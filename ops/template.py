...
class BGE_TOOLS_OT_Template(types.Operator):
	bl_idname = "bge_tools.template"
	bl_label = "BGE-Tools: Template"
...
def register():
	bpy.utils.register_class(BGE_TOOLS_OT_Template)
	
def unregister():
	bpy.utils.unregister_class(BGE_TOOLS_OT_Template)
